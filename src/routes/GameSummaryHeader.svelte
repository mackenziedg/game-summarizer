<script lang="ts">
  ...
  const home_team_weight = home_team_score > away_team_score ? "font-extrabold" : "font-normal";
  const away_team_weight = away_team_score > home_team_score ? "font-extrabold" : "font-normal";
</script>
